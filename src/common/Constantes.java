...
public class Constantes {
	...
	public static final Integer[] ESTADOS_INACTIVIDAD = new Integer[] { EContrato.FUNDIDO, EContrato.CANCELADO,
			EContrato.VITRINA, 10, EContrato.REMATADO, EContrato.USO_OFICINA, EContrato.VITRINA_SP, EContrato.ANULADO };
