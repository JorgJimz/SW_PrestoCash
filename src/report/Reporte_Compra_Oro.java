...
public class Reporte_Compra_Oro extends JInternalFrame{
	...
	public Reporte_Compra_Oro() {
		this.setVisible(true);
		this.setLayout(null);
		this.setSize(736, 107);
		this.setClosable(true);
		this.setTitle("REPORTE DE COMPRA DE ORO MENSUAL");
	...
	public void mostrarReporteCompraOro() {
		...
		try {
			JasperReport reporte = (JasperReport) JRLoader
					.loadObject("reporte_compra_oro.jasper");
