...
*/
public class Reporte_Comision_Oro extends JInternalFrame{
	...
	public void mostrarReporte() {
		...
		parametros.put("a", ychAnio.getYear());
		parametros.put(JRParameter.REPORT_LOCALE, Locale.US);
		try {
			JasperReport reporte = (JasperReport) JRLoader
					.loadObject("reporte_comision_oro.jasper");
