...
public class Gestion_Contrato extends JInternalFrame {
	...
	public Gestion_Contrato(Contrato c) throws ParseException {
		...
		lblNumeroContrato = new JLabel(contrato.getFlag() + "-"
				+ String.valueOf(contrato.getNumero()));
				...
				if (Utiles.Validar(pnlCargoContainer)) {
					...
					for (int i = 0; i <= Constantes.DetalleContratoModel
						...
						if (estado == 99) {
							...
							Articulo articulo = new ArticuloController().ObtenerArticulo(Integer
									.parseInt(Constantes.DetalleContratoModel
	...
	public void ActivarPerspectivaCancelado(Contrato k) {
		...
		edpMensajeSuceso.setText("<html>"
				...
				+ "<h3>DÍA: "
				+ Constantes.formatoLocal.format(LocalDate.parse(cancelacion
						.getFechaPago())) + " </h3>" + "<h3>IMPORTE: "
